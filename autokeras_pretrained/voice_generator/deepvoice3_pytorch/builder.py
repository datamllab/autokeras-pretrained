from autokeras_pretrained.voice_generator.deepvoice3_pytorch.model import MultiSpeakerTTSModel, AttentionSeq2Seq
...
def deepvoice3(n_vocab, embed_dim=256, mel_dim=80, linear_dim=513, r=4, n_speakers=1, speaker_embed_dim=16,
    ...
    """Build deepvoice3
    """
    from autokeras_pretrained.voice_generator.deepvoice3_pytorch.deepvoice3 import Encoder, Decoder, Converter
